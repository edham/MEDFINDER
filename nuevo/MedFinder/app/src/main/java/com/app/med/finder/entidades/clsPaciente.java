...
public class clsPaciente {
    ...
    public clsPaciente(String entidad) {
        String [] parametro = entidad.split("\\<+atributo+>");   
        this.int_id_paciente = Integer.parseInt(parametro[0].trim());
        ...
        this.dat_fecha_nacimiento = new Date(Long.parseLong(parametro[5].trim()));
        this.bol_sexo = Boolean.parseBoolean(parametro[6].trim());
        this.bol_tipo = Boolean.parseBoolean(parametro[7].trim());
        this.int_estatura = Integer.parseInt(parametro[8].trim());
        this.bol_cardiovasculares = Boolean.parseBoolean(parametro[9].trim());
        this.bol_musculares = Boolean.parseBoolean(parametro[10].trim());
        this.bol_digestivos = Boolean.parseBoolean(parametro[11].trim());
        this.bol_alergicos = Boolean.parseBoolean(parametro[12].trim());
        this.bol_alcohol = Boolean.parseBoolean(parametro[13].trim());
        this.bol_tabaquismo = Boolean.parseBoolean(parametro[14].trim());
        this.bol_drogas = Boolean.parseBoolean(parametro[15].trim());
        this.bol_psicologicos = Boolean.parseBoolean(parametro[16].trim());
        this.int_estado = Integer.parseInt(parametro[17].trim());
        this.int_id_persona = Integer.parseInt(parametro[18].trim());
        this.objUsuario = new clsUsuario(Integer.parseInt(parametro[19].trim()));
    ...
    public String toString() {
        return str_nombres + " " + str_apellido_paterno + " " + str_apellido_materno;
    }
