...
public class clsNegocioDAO {
    ...
    private static String NOMBRE_TABLA="NEGOCIO";
    ...
    public static List<clsNegocio> ListarUbicacionActivacion(Context context,int estado)
    {
        ...
        if(bd!=null)
        {
            String query="select en.int_id,en.str_nombre,en.str_comercial,en.str_tipo,en.str_ruc," +
                    ...
                    "on pe.int_id=en.id_persona where en.int_ubicacion_activacion="+estado ;
