...
import com.sinergia.seguridad.fragment.DataFragment;
import com.sinergia.seguridad.fragment.InicioFragment;
    ...
    final Handler handlerSesion =new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            if(validador) {
                ...
                clsSesionVigilanciaDAO.Borrar(MainActivity1.this);
                clsTrackDAO.Borrar(MainActivity1.this);
                clsVehiculoDAO.Borrar(MainActivity1.this);
                clsCuadranteDAO.Borrar(MainActivity1.this);
                clsEntidadDAO.Borrar(MainActivity1.this);
                clsPersonalDAO.Borrar(MainActivity1.this);
                Intent svc = new Intent(MainActivity1.this, clsGPSTrackService.class);
                stopService(svc);
                pd.dismiss();
                finish();
            }
