...
public class ResponderPreguntaPacienteHTTP extends AsyncTask<Object, Integer, String>
{
	...
	{
        clsRespuestaPreguntaPaciente entidad= (clsRespuestaPreguntaPaciente)params[0];
        ...
        try {
            ...
            Value.add(new BasicNameValuePair("IdPregunta",""+entidad.getInt_id_pregunta_paciente()));
            Value.add(new BasicNameValuePair("respuesta",entidad.getStr_detalle()));
