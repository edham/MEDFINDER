...
public class clsRespuestaCasosSaludDAO {
    ...
    public static boolean AgregarLogin(Context context,String data,boolean login)
    {
        ...
        try
        {
            ...
            for(int i=0;i<listEmpresaJSON.length();i++){
                ...
                registro.put("int_total",(json_data.isNull("respuestaCasosSaludCali"))?0:json_data.getInt("respuestaCasosSaludCali"));
    ...
    public static boolean ActualizarPuntaje(Context context,String data)
    {
        boolean retorno=true;
        int id;
        bdSQLite admin=new bdSQLite(context, null);
        ...
        try
        {
            ...
            for(int i=0;i<listEmpresaJSON.length();i++){
                ...
                id = bd.update(NOMBRE_TABLA, registro, "int_id_respuesta_casos_salud="+json_data.getInt("respuestaCasosSaludId"), null);
     ...
     public static int Agregar(Context context, clsRespuestaCasosSalud entidad)
    {
        ...
        registro.put("int_total",entidad.getInt_total());
        ...
        SQLiteDatabase bd=admin.getWritableDatabase();
         if(bd!=null)
         {
            String query="select int_id_respuesta_casos_salud,int_id_doctor,int_id_casos_salud,str_descripcion,"
                    + "int_puntaje,int_total from "+NOMBRE_TABLA+" where int_id_casos_salud="+id;
            ...
            fila.moveToFirst();   
                ...
                {   
                    ...
                    entidad.setInt_total(fila.getInt(5));
