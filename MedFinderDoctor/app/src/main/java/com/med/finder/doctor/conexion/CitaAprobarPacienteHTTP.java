...
public class CitaAprobarPacienteHTTP extends AsyncTask<Object, Integer, String>
{
	...
	protected String doInBackground(Object... params)
	{
        ...
        try {
            ...
            if(entidad.getDat_atencion()!=null)
                Value.add(new BasicNameValuePair("fecha",""+entidad.getDat_atencion().getTime()));
