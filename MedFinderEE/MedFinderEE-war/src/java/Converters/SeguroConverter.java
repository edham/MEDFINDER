...
import Controlador.ManagedBeanSeguro;
 ...
 * @author yzavaleta
 */
@FacesConverter("seguroConverter")
public class SeguroConverter implements Converter{
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        ValueExpression vex = ctx.getApplication().getExpressionFactory().createValueExpression(ctx.getELContext(), "#{managedBeanSeguro}", ManagedBeanSeguro.class);
        ManagedBeanSeguro managedBean = (ManagedBeanSeguro) vex.getValue(ctx.getELContext());
        Seguro objeto;
        try {
